...
const gardenEntries = [
    ...
    },
    {
        ...
        content: `
            ...
            大約兩週前，シンデイ從園藝社的前輩那裡聽說，學校附近常常有流浪貓出沒，牠們有時會悄悄溜進校園，在體育館的屋簷下躲雨，或是在舊校舍的窗台上曬太陽。
            從那天起，一個名為「貓草種植計畫」的念頭便在シンデイ心中悄然萌芽。
            シンデイ提著一個小巧的藍色灑水壺，踮著腳尖，小心翼翼地朝那個角落走去。她的心裡揣著一個甜蜜而微小的祕密。
            </div>
            <div class="story-paragraph">
